...
import 'package:friday_virtual_assistant/screens/new_screen.dart';
...
import '../repository/HistoryChatRepository.dart';
    ...
    await APIService().requestOpenAI(userInput, modeOpenAI, 2000).then((value)
    {
      ...
      if(modeOpenAI == "chat")
      {
        setState(() {
          ...
          historyChatController.postData(userInput, answerTextFromOpenAI, false);
        });

        if(speakFRIDAY == true)
        {
          textToSpeechInstance.setLanguage("en-US");
      ...
      else
      {
        ...
        setState(() {
          ...
          // historyChatController.postData(userInput, imageUrlFromOpenAI, true);
        });
      }
